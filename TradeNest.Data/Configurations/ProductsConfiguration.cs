...
public class ProductsConfiguration : IEntityTypeConfiguration<Product>
{
    ...
    private IEnumerable<Product> SeedProducts()
    {
        ...
        IEnumerable<Product> productsToSeed = new Product[]
        {
            ...
            new Product
            {
                Id = Guid.Parse("c3d4e5f6-a7b8-9012-3333-444455556666"),
                Name = "The Martian by Andy Weir",
                Description = "An enthralling science fiction novel about an astronaut stranded on Mars and his ingenious fight for survival. A must-read for sci-fi fans.",
                QuantityInStock = 200,
                CostPrice = 7.50m,
                SellingPrice = 14.99m,
