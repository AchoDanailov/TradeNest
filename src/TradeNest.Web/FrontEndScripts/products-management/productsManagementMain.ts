...
const controlsDivEl = document.querySelector<HTMLDivElement>("div#controls")!;
...
function mainTemplate(): TemplateResult {
    return html`
...
async function showProducts(approvalStatus: ProductsApprovalStatus): Promise<void> {
