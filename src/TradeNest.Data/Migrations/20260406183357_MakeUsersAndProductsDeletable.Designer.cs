...
namespace TradeNest.Data.Migrations
{
    ...
    [Migration("20260406183357_MakeUsersAndProductsDeletable")]
    partial class MakeUsersAndProductsDeletable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TradeNest.Data.Models.ApplicationRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TradeNest.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<bool>("PersonalInformationIsDeleted")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("TradeNest.Data.Models.ApplicationUserRole", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("TradeNest.Data.Models.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TradeNest.Data.Models.ApplicationUserRole", b =>
                {
                    b.HasOne("TradeNest.Data.Models.ApplicationRole", "Role")
                        .WithMany("UserRoles")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
